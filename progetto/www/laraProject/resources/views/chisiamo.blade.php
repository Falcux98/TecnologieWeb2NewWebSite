    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h2 class="title text-center">Mettiti in contatto con noi</h2>
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Scrivi qui il tuo messaggio..."></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				<h2 class="title text-center">Info Contatti</h2>
	    				<address>
	    					<p>TecnologieWeb shop Inc.</p>
							<p>Via Brecce Bianche 12,  60131, AN</p>
							<p>Ancona IT</p>
							<p>Mobile: +39346 1234567</p>
							<p>Fax: 0000000</p>
